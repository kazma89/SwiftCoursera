...
struct MensajePositivo {
    let mensajePositivo = ["Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
    ...
    func regresaMensajePositivoAleatorio() -> String{
        let posicion = Int (arc4random()) % mensajePositivo.count
        return mensajePositivo[posicion]
    }
}
